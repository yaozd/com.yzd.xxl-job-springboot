 ...
 */
@JobHandler(value="QJLianlianJob_ClearOvertimeOrderHandler")
@Component
public class QJLianlianJob_ClearOvertimeOrderHandler extends IJobHandler {
    @Autowired
    QJLianlianJob qjLianlianJob;
    public ReturnT<String> execute(String s) throws Exception {
        //把具体的打点信息放在job中
        //XxlJobLogger.log("execute QJLianlianJob_ClearOvertimeOrderHandler");
        qjLianlianJob.clearOvertimeOrder();
        return SUCCESS;
    }
}
